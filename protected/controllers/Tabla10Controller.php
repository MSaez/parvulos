...
class Tabla10Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla10']))
		{
			$model->attributes=$_POST['Tabla10'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T10));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla10');
	...
	{
		$model=new Tabla10('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla10']))
			$model->attributes=$_GET['Tabla10'];
	 ...
	 * @return Tabla10 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla10::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla10 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla10-form')
		{
