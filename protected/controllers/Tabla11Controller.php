...
class Tabla11Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla11']))
		{
			$model->attributes=$_POST['Tabla11'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T11));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla11');
	...
	{
		$model=new Tabla11('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla11']))
			$model->attributes=$_GET['Tabla11'];
	 ...
	 * @return Tabla11 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla11::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla11 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla11-form')
		{
