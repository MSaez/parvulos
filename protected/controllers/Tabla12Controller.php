...
class Tabla12Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla12']))
		{
			$model->attributes=$_POST['Tabla12'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T12));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla12');
	...
	{
		$model=new Tabla12('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla12']))
			$model->attributes=$_GET['Tabla12'];
	 ...
	 * @return Tabla12 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla12::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla12 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla12-form')
		{
