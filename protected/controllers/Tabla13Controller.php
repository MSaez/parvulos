...
class Tabla13Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla13']))
		{
			$model->attributes=$_POST['Tabla13'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T13));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla13');
	...
	{
		$model=new Tabla13('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla13']))
			$model->attributes=$_GET['Tabla13'];
	 ...
	 * @return Tabla13 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla13::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla13 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla13-form')
		{
