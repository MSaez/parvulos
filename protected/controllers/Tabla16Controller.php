...
class Tabla16Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla16']))
		{
			$model->attributes=$_POST['Tabla16'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T16));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla16');
	...
	{
		$model=new Tabla16('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla16']))
			$model->attributes=$_GET['Tabla16'];
	 ...
	 * @return Tabla16 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla16::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla16 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla16-form')
		{
