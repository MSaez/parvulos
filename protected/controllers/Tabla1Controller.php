...
class Tabla1Controller extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla1']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T1));
		}
	...
	{
		$model=new Tabla1('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla1']))
			$model->attributes=$_GET['Tabla1'];
	 ...
	 * @return Tabla1 the loaded model
	 ...
	 * @param Tabla1 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla1-form')
		{
