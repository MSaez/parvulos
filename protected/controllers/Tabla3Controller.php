...
class Tabla3Controller extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla3']))
		{
			...
			if($model->save())
				...
				$this->redirect(array('view','id'=>$model->ID_T3));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla3');
	...
	{
		$model=new Tabla3('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla3']))
			$model->attributes=$_GET['Tabla3'];
	 ...
	 * @return Tabla3 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla3::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla3 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla3-form')
		{
