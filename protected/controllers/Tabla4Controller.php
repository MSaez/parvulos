...
class Tabla4Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla4']))
		{
			$model->attributes=$_POST['Tabla4'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T4));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla4');
	...
	{
		$model=new Tabla4('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla4']))
			$model->attributes=$_GET['Tabla4'];
	 ...
	 * @return Tabla4 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla4::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla4 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla4-form')
		{
