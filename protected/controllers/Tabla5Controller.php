...
class Tabla5Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla5']))
		{
			$model->attributes=$_POST['Tabla5'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T5));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla5');
	...
	{
		$model=new Tabla5('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla5']))
			$model->attributes=$_GET['Tabla5'];
	 ...
	 * @return Tabla5 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla5::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla5 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla5-form')
		{
