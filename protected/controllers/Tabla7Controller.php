...
class Tabla7Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla7']))
		{
			$model->attributes=$_POST['Tabla7'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T7));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla7');
	...
	{
		$model=new Tabla7('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla7']))
			$model->attributes=$_GET['Tabla7'];
	 ...
	 * @return Tabla7 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla7::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla7 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla7-form')
		{
