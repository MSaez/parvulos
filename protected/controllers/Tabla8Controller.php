...
class Tabla8Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla8']))
		{
			$model->attributes=$_POST['Tabla8'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T8));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla8');
	...
	{
		$model=new Tabla8('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla8']))
			$model->attributes=$_GET['Tabla8'];
	 ...
	 * @return Tabla8 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tabla8::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tabla8 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla8-form')
		{
