...
class Tabla9Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tabla9']))
		{
			$model->attributes=$_POST['Tabla9'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->ID_T9));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Tabla9');
	...
	{
		$model=new Tabla9('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tabla9']))
			$model->attributes=$_GET['Tabla9'];
	 ...
	 * @return Tabla9 the loaded model
	 ...
	 * @param Tabla9 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tabla9-form')
		{
