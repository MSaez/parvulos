...
/**
 * This is the model class for table "tabla15".
 *
 * The followings are the available columns in table 'tabla15':
 * @property integer $ID_T15
 ...
 * @property string $A13_E1
 * @property string $A13_E2
 * @property string $A13_E3
 * @property string $A14_E1
 * @property string $A14_E2
 * @property string $A14_E3
 * @property string $A15_E1
 * @property string $A15_E2
 * @property string $A15_E3
 * @property string $A16_E1
 * @property string $A16_E2
 * @property string $A16_E3
 * @property string $A17_E1
 * @property string $A17_E2
 * @property string $A17_E3
 * @property string $A18_E1
 * @property string $A18_E2
 * @property string $A18_E3
 * @property string $A19_E1
 * @property string $A19_E2
 * @property string $A19_E3
 * @property string $A20_E1
 * @property string $A20_E2
 * @property string $A20_E3
 * @property string $E1
 * @property string $E2
 * @property string $E3
 *
 ...
 */
class Tabla15 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ID_CURSA, RUT_A, A1_E1, A1_E2, A1_E3, A2_E1, A2_E2, A2_E3, A3_E1, A3_E2, A3_E3, A4_E1, A4_E2, A4_E3, A5_E1, A5_E2, A5_E3, A6_E1, A6_E2, A6_E3, A7_E1, A7_E2, A7_E3, A8_E1, A8_E2, A8_E3, A9_E1, A9_E2, A9_E3, A10_E1, A10_E2, A10_E3, A11_E1, A11_E2, A11_E3, A12_E1, A12_E2, A12_E3, A13_E1, A13_E2, A13_E3, A14_E1, A14_E2, A14_E3, A15_E1, A15_E2, A15_E3, A16_E1, A16_E2, A16_E3, A17_E1, A17_E2, A17_E3, A18_E1, A18_E2, A18_E3, A19_E1, A19_E2, A19_E3, A20_E1, A20_E2, A20_E3', 'required'),
			array('ID_CURSA, ANIO_C', 'numerical', 'integerOnly'=>true),
			array('RUT_A', 'length', 'max'=>12),
			array('A1_E1, A1_E2, A1_E3, A2_E1, A2_E2, A2_E3, A3_E1, A3_E2, A3_E3, A4_E1, A4_E2, A4_E3, A5_E1, A5_E2, A5_E3, A6_E1, A6_E2, A6_E3, A7_E1, A7_E2, A7_E3, A8_E1, A8_E2, A8_E3, A9_E1, A9_E2, A9_E3, A10_E1, A10_E2, A10_E3, A11_E1, A11_E2, A11_E3, A12_E1, A12_E2, A12_E3, A13_E1, A13_E2, A13_E3, A14_E1, A14_E2, A14_E3, A15_E1, A15_E2, A15_E3, A16_E1, A16_E2, A16_E3, A17_E1, A17_E2, A17_E3, A18_E1, A18_E2, A18_E3, A19_E1, A19_E2, A19_E3, A20_E1, A20_E2, A20_E3', 'length', 'max'=>2),
			array('E1, E2, E3', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID_T15, ID_CURSA, RUT_A, ANIO_C, A1_E1, A1_E2, A1_E3, A2_E1, A2_E2, A2_E3, A3_E1, A3_E2, A3_E3, A4_E1, A4_E2, A4_E3, A5_E1, A5_E2, A5_E3, A6_E1, A6_E2, A6_E3, A7_E1, A7_E2, A7_E3, A8_E1, A8_E2, A8_E3, A9_E1, A9_E2, A9_E3, A10_E1, A10_E2, A10_E3, A11_E1, A11_E2, A11_E3, A12_E1, A12_E2, A12_E3, A13_E1, A13_E2, A13_E3, A14_E1, A14_E2, A14_E3, A15_E1, A15_E2, A15_E3, A16_E1, A16_E2, A16_E3, A17_E1, A17_E2, A17_E3, A18_E1, A18_E2, A18_E3, A19_E1, A19_E2, A19_E3, A20_E1, A20_E2, A20_E3, E1, E2, E3', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'A13_E1' => 'Atributo 13 Evaluación 1',
			'A13_E2' => 'Atributo 13 Evaluación 2',
			'A13_E3' => 'Atributo 13 Evaluación 3',
			'A14_E1' => 'Atributo 14 Evaluación 1',
			'A14_E2' => 'Atributo 14 Evaluación 2',
			'A14_E3' => 'Atributo 14 Evaluación 3',
			'A15_E1' => 'Atributo 15 Evaluación 1',
			'A15_E2' => 'Atributo 15 Evaluación 2',
			'A15_E3' => 'Atributo 15 Evaluación 3',
			'A16_E1' => 'Atributo 16 Evaluación 1',
			'A16_E2' => 'Atributo 16 Evaluación 2',
			'A16_E3' => 'Atributo 16 Evaluación 3',
			'A17_E1' => 'Atributo 17 Evaluación 1',
			'A17_E2' => 'Atributo 17 Evaluación 2',
			'A17_E3' => 'Atributo 17 Evaluación 3',
			'A18_E1' => 'Atributo 18 Evaluación 1',
			'A18_E2' => 'Atributo 18 Evaluación 2',
			'A18_E3' => 'Atributo 18 Evaluación 3',
			'A19_E1' => 'Atributo 19 Evaluación 1',
			'A19_E2' => 'Atributo 19 Evaluación 2',
			'A19_E3' => 'Atributo 19 Evaluación 3',
			'A20_E1' => 'Atributo 20 Evaluación 1',
			'A20_E2' => 'Atributo 20 Evaluación 2',
			'A20_E3' => 'Atributo 20 Evaluación 3',
			'E1' => 'Evaluación 1',
			'E2' => 'Evaluación 2',
			'E3' => 'Evaluación 3',
		);
	...
	public function search()
	{
		...
		$criteria->compare('ID_T15',$this->ID_T15);
		...
		$criteria->compare('A13_E1',$this->A13_E1,true);
		$criteria->compare('A13_E2',$this->A13_E2,true);
		$criteria->compare('A13_E3',$this->A13_E3,true);
		$criteria->compare('A14_E1',$this->A14_E1,true);
		$criteria->compare('A14_E2',$this->A14_E2,true);
		$criteria->compare('A14_E3',$this->A14_E3,true);
		$criteria->compare('A15_E1',$this->A15_E1,true);
		$criteria->compare('A15_E2',$this->A15_E2,true);
		$criteria->compare('A15_E3',$this->A15_E3,true);
		$criteria->compare('A16_E1',$this->A16_E1,true);
		$criteria->compare('A16_E2',$this->A16_E2,true);
		$criteria->compare('A16_E3',$this->A16_E3,true);
		$criteria->compare('A17_E1',$this->A17_E1,true);
		$criteria->compare('A17_E2',$this->A17_E2,true);
		$criteria->compare('A17_E3',$this->A17_E3,true);
		$criteria->compare('A18_E1',$this->A18_E1,true);
		$criteria->compare('A18_E2',$this->A18_E2,true);
		$criteria->compare('A18_E3',$this->A18_E3,true);
		$criteria->compare('A19_E1',$this->A19_E1,true);
		$criteria->compare('A19_E2',$this->A19_E2,true);
		$criteria->compare('A19_E3',$this->A19_E3,true);
		$criteria->compare('A20_E1',$this->A20_E1,true);
		$criteria->compare('A20_E2',$this->A20_E2,true);
		$criteria->compare('A20_E3',$this->A20_E3,true);
	 ...
	 * @return Tabla15 the static model class
	 */
