...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ID_T1')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->ID_T1), array('view', 'id'=>$data->ID_T1)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('A9_E1')); ?>:</b>
	<?php echo CHtml::encode($data->A9_E1); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A9_E2')); ?>:</b>
	<?php echo CHtml::encode($data->A9_E2); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A9_E3')); ?>:</b>
	<?php echo CHtml::encode($data->A9_E3); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A10_E1')); ?>:</b>
	<?php echo CHtml::encode($data->A10_E1); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A10_E2')); ?>:</b>
	<?php echo CHtml::encode($data->A10_E2); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A10_E3')); ?>:</b>
	<?php echo CHtml::encode($data->A10_E3); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A11_E1')); ?>:</b>
	<?php echo CHtml::encode($data->A11_E1); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A11_E2')); ?>:</b>
	<?php echo CHtml::encode($data->A11_E2); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A11_E3')); ?>:</b>
	<?php echo CHtml::encode($data->A11_E3); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A12_E1')); ?>:</b>
	<?php echo CHtml::encode($data->A12_E1); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A12_E2')); ?>:</b>
	<?php echo CHtml::encode($data->A12_E2); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('A12_E3')); ?>:</b>
	<?php echo CHtml::encode($data->A12_E3); ?>
	<br />
	*/ ?>
