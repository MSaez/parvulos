...
$this->menu=array(
	...
	array('label'=>'Actualizar Evaluación', 'url'=>array('update', 'id'=>$model->ID_T2)),
	array('label'=>'Eliminar Evaluación', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->ID_T2),'confirm'=>'¿Seguro que quieres borrar este elemento?')),
	);
?>
