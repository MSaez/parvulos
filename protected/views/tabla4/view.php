...
$this->menu=array(
	...
	array('label'=>'Actualizar Evaluación', 'url'=>array('update', 'id'=>$model->ID_T4)),
	array('label'=>'Eliminar Evaluación', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->ID_T4),'confirm'=>'¿Seguro que quieres borrar este elemento?')),
);
?>

<h1>Ver Evaluación #<?php echo $model->ID_T4; ?></h1>
