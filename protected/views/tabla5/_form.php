...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<table>
		...
		<tr>
			...
			<td width="500px">
				<h5>Menciona si está alegre, triste o enojado(a), cuando se le pregunta.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Señala o manifiesta expresiones de alegría, enojo, tristeza o miedo, en relatos o ilustraciones.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Participa en actividades que producen interés o agrado en el grupo. Por ejemplo, bailes, canciones, obras de teatro, etc.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Comenta los motivos de su alegría, tristeza, rabia u otros sentimientos. Por ejemplo, dice que está triste porque su perro está enfermo.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Menciona algunas emociones de otros o de sí mismo cuando se le pregunta. Por ejemplo, al responder preguntas como ¿qué le pasa a tu compañero que está llorando?</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Propone actividades o juegos divertidos para él y sus compañeros(as). Por ejemplo, bailar, contar chistes, cantar, celebrar cumpleaños.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Acepta cambiar de actividad aunque esté entretenido, respetando los turnos de sus compañeros.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Ayuda a un(a) compañero(a) que tiene un problema, apoyándolo con palabras o gestos de cariño.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Realiza acciones para provocar alegría en otras personas. Por ejemplo, dice chistes o anécdotas divertidas, hace mímicas, etc.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Ayuda a resolver conflictos en forma pacífica, interviniendo cuando otros niños o niñas discuten.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Interrumpe o pospone sus actividades para ayudar a otros. Por ejemplo, detiene un juego para ayudar a un compañero (a) que se ha caído.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Comenta la importancia del buen humor para mantener el bienestar del curso.</h5>
			</td>
			<td>
				<div class="row">
