...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<table>
		...
		<tr>
			...
			<td width="500px">
				<h5>Menciona algunas normas grupales cuando se le pregunta.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Nombra algunas tradiciones culturales propias de su país. Por ejemplo, bailes o comidas típicas.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Cumple las normas establecidas por el grupo. Por ejemplo, levanta la mano antes de hablar o espera en silencio cuando un compañero habla.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Comenta costumbres de otras culturas que llaman su atención. Por ejemplo, “en Chiloé las casas están sobre el agua”.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Comenta por qué una norma es importante para la convivencia del grupo. Por ejemplo, “hay que dejar la silla ordenada para que los demás puedan pasar”.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Realiza comentarios positivos en relación a otras formas de vida y costumbres que conoce. Por ejemplo, “me gusta como dicen hola en Isla de Pascua”.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Propone una norma o idea para mejorar la convivencia del grupo.</h5>
			</td>
			<td>
				<div class="row">
		...
		<tr>
			...
			<td>
				<h5>Explica por qué cree que es importante que existan otras culturas, considerando aspectos como características fisonómicas, lingüísticas u otras, cuando se le pregunta.</h5>
			</td>
			<td>
				<div class="row">
